...
export const ContactSection = () => {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className="contact-section py-16 px-6 bg-gradient-to-br from-indigo-50 to-purple-50"
    >
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Pillanji, South Extension, Delhi</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:9971691558" className="text-indigo-600 hover:underline">
                      9971691558
                    </a>
                  </div>
                </div>
